...
const AdminSettings = ({
  ...
  const cardClass = `p-6 rounded-xl ${isDarkMode ? 'bg-gray-700' : 'bg-white shadow-md'}`;
    ...
    <div>
      ...
      {activeSettingsTab === 'store' && (
        <div className={cardClass}>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure your store's basic information and policies.</p>
      ...
      {activeSettingsTab === 'admin' && (
        <div className={cardClass}>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure your notification preferences and admin settings.</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="font-medium text-lg mb-3">Inventory Alerts</h3>
              <div className="flex items-center mb-3">
                <input
                  ...
                  className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded"
                />
                <label htmlFor="alertLowStock" className="ml-2 block text-sm">
      ...
      {activeSettingsTab === 'system' && (
        <div className={cardClass}>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">View system statistics and information.</p>
          
          {(() => {
            const systemInfo = getSystemInformation();
            const statCardClass = `p-4 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-gray-50'}`;
            
            return (
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className={statCardClass}>
                    <h3 className="text-lg font-medium mb-3">Store Statistics</h3>
                    {[
                  ...
                  <div className={statCardClass}>
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                      <h4 className="text-md font-medium mb-2">Order Completion Rate</h4>
                      <div className="relative pt-1">
                        <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-300 dark:bg-gray-600">
                ...
                <div className={statCardClass}>
                  ...
                  {[
                    ...
                    <div key={index} className="flex justify-between mb-2">
                      <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>{info.label}:</span>
